...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inExpr}\mathrel{=}[\mskip1.5mu \Conid{Num},\Varid{f}\;\Conid{Bop}\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{inExpr}\mathrel{=}\alt{\Conid{Num}}{\lambda (\Varid{x},(\Varid{y},\Varid{z}))\to \Conid{Bop}\;\Varid{y}\;\Varid{x}\;\Varid{z}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&
    \ensuremath{\Conid{Int}\mathbin{+}\Conid{Op}\times(\Conid{Expr}\times\Conid{Expr})}
           \ar[d]^{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times((\Varid{cataExpr}\;\Varid{g})\times(\Varid{cataExpr}\;\Varid{g})}}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{opCorresponde}\mathbin{::}\Conid{Op}\to (\Conid{Int},\Conid{Int})\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{opCorresponde}\;(\Conid{Op}\;\text{\tt \char34 +\char34})\mathrel{=}\uncurry{(\mathbin{+})}{}\<[E]%
\\
\>[B]{}\Varid{opCorresponde}\;(\Conid{Op}\;\text{\tt \char34 -\char34})\mathrel{=}\uncurry{(\mathbin{-})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calcula}\mathbin{::}\Conid{Expr}\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{calcula}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{id}}{\uncurry{\Varid{opCorresponde}}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{compile}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{singl}\comp \Varid{showInt}}{\Varid{posOrd}}\comp \p1\comp \Varid{head}\comp \Varid{readExp}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{posOrd}\mathrel{=}\uncurry{(\plus )}\comp \Varid{swap}\comp ((\Varid{singl}\comp \Varid{showOp})\times\uncurry{(\plus )}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{showInt}\mathrel{=}(\plus )\;\text{\tt \char34 PUSH~\char34}\comp \Varid{show}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{showOp}\mathbin{::}\Conid{Op}\to \Conid{String}{}\<[E]%
\\
\>[B]{}\Varid{showOp}\;(\Conid{Op}\;\text{\tt \char34 +\char34})\mathrel{=}\text{\tt \char34 ADD\char34}{}\<[E]%
\\
\>[B]{}\Varid{showOp}\;(\Conid{Op}\;\text{\tt \char34 *\char34})\mathrel{=}\text{\tt \char34 MUL\char34}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{3}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{show'}\mathrel{=}\Varid{cataExpr}\;\alt{\Varid{show}}{\Varid{showAux}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{showAux}\;((\Conid{Op}\;\Varid{a}),(\Varid{s1},\Varid{s2}))\mathrel{=}\text{\tt \char34 (\char34}\plus \Varid{s1}\plus \text{\tt \char34 ~\char34}\plus \Varid{a}\plus \text{\tt \char34 ~\char34}\plus \Varid{s2}\plus \text{\tt \char34 )\char34}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{inL2D}\mathrel{=}\alt{\Conid{Unid}}{\lambda (\Varid{b},(\Varid{x1},\Varid{x2}))\to \Conid{Comp}\;\Varid{b}\;\Varid{x1}\;\Varid{x2}}{}\<[E]%
\\[\blanklineskip]%
...
\\
\>[B]{}\Varid{dimen}\mathrel{=}\Varid{cataL2D}\;\alt{(\Varid{fromIntegral}\times\Varid{fromIntegral})\comp \p1}{\uncurry{\Varid{getDem}}\comp (\Varid{id}\times\Varid{joinAxis})}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{joinAxis}\mathrel{=}\conj{\p1\times\p1}{\p2\times\p2}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{getDem}\mathbin{::}\Conid{Tipo}\to ((\Conid{Float},\Conid{Float}),(\Conid{Float},\Conid{Float}))\to (\Conid{Float},\Conid{Float}){}\<[E]%
\\
\>[B]{}\Varid{getDem}\;\Conid{V}\mathrel{=}(\Varid{uMax}\times\Varid{uAdd}){}\<[E]%
\\
\>[B]{}\Varid{getDem}\;\Conid{Vd}\mathrel{=}(\Varid{uMax}\times\Varid{uAdd}){}\<[E]%
\\
\>[B]{}\Varid{getDem}\;\Conid{Ve}\mathrel{=}(\Varid{uMax}\times\Varid{uAdd}){}\<[E]%
\\
\>[B]{}\Varid{getDem}\;\anonymous \mathrel{=}(\Varid{uAdd}\times\Varid{uMax}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{uMax}\mathrel{=}\uncurry{\Varid{max}}{}\<[E]%
\\
\>[B]{}\Varid{uAdd}\mathrel{=}\uncurry{(\mathbin{+})}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{calcOrigins}\mathrel{=}\Varid{anaL2D}\;(\alt{i_1\comp \Varid{id}}{i_2\comp \Varid{fty}}\comp \Varid{distl}\comp (\Varid{outL2D}\times\Varid{id})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{fty}{}\<[14]%
\>[14]{}\mathrel{=}\lambda ((\Varid{t},(\Varid{x1},\Varid{x2})),\Varid{o})\to ((),((\Varid{x1},\Varid{o}),(\Varid{x2},\Varid{calc}\;\Varid{t}\;\Varid{o}\;(\Varid{dimen}\;\Varid{x1})))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calc}\mathbin{::}\Conid{Tipo}\to \Conid{Origem}\to (\Conid{Float},\Conid{Float})\to \Conid{Origem}{}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Conid{V}\;\Varid{o}\;(\Varid{a},\Varid{b})\mathrel{=}\Varid{sumTup}\;\Varid{o}\;(\Varid{a}\mathbin{/}\mathrm{2},\Varid{b}){}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Conid{Vd}\;\Varid{o}\;\Varid{b}\mathrel{=}\Varid{sumTup}\;\Varid{o}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Conid{Ve}\;\Varid{o}\;(\Varid{a},\Varid{b})\mathrel{=}\Varid{sumTup}\;\Varid{o}\;(\mathrm{0},\Varid{b}){}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Conid{H}\;\Varid{o}\;(\Varid{a},\Varid{b})\mathrel{=}\Varid{sumTup}\;\Varid{o}\;(\Varid{a},\Varid{b}\mathbin{/}\mathrm{2}){}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Conid{Hb}\;\Varid{o}\;(\Varid{a},\Varid{b})\mathrel{=}\Varid{sumTup}\;\Varid{o}\;(\Varid{a},\mathrm{0}){}\<[E]%
\\
\>[B]{}\Varid{calc}\;\Conid{Ht}\;\Varid{o}\;\Varid{b}\mathrel{=}\Varid{sumTup}\;\Varid{o}\;\Varid{b}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{sumTup}\;(\Varid{a},\Varid{b})\;(\Varid{c},\Varid{d})\mathrel{=}(\Varid{a}\mathbin{+}\Varid{c},\Varid{b}\mathbin{+}\Varid{d}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\>[B]{}\Varid{agrup\char95 caixas}\mathbin{::}\Conid{X}\;(\Conid{Caixa},\Conid{Origem})\;()\to \Conid{Fig}{}\<[E]%
\\
\>[B]{}\Varid{agrup\char95 caixas}\mathrel{=}\Varid{cataList}\;\alt{\Varid{nil}}{\uncurry{(\mathbin{:})}\comp (\Varid{swap}\times\Varid{id})}\comp \Varid{collectLeafs}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{caixasAndOrigin2Pict}\mathrel{=}\Varid{\Conid{G}.pictures}\comp \Varid{cataList}\;\alt{\Varid{nil}}{\uncurry{(\mathbin{:})}\comp (\Varid{makePic}\times\Varid{id})}\comp \Varid{agrup\char95 caixas}\comp \Varid{calcOrigins}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{makePic}\;(\Varid{org},((\Varid{ii},\Varid{ij}),(\Varid{t},\Varid{c})))\mathrel{=}\Varid{crCaixa}\;\Varid{org}\;(\Varid{fromIntegral}\;\Varid{ii})\;(\Varid{fromIntegral}\;\Varid{ij})\;\Varid{t}\;\Varid{c}{}\<[E]%
\\[\blanklineskip]%
...
Seja $c\ x\ n = \sum_{i=0}^{n} \frac{(-1)^i}{(2i)!} x^{2i}$ a função que permite obter está aproximação, então resulta que \ensuremath{\Varid{c}\;\Varid{x}\;\mathrm{0}\mathrel{=}\mathrm{1}} e que $\ensuremath{\Varid{c}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})} = \ensuremath{\Varid{c}\;\Varid{x}\;\Varid{n}} + \frac{(-1)^{n + 1}}{(2n + 2)!} x^{2n + 2}$. Esta função é passivél de ser simplificada, definindo $\ensuremath{\Varid{k}\;\Varid{x}\;\Varid{n}} = \frac{(-1)^{n + 1}}{(2n + 2)!} x^{2n + 2}$ a partir do qual se obtem que $\ensuremath{\Varid{k}\;\Varid{x}\;\mathrm{0}} = \frac{-x^2}{2}$ e que $\ensuremath{\Varid{k}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})} = \frac{-x^2}{2(n + 2)(2n + 3)} (\ensuremath{\Varid{k}\;\Varid{x}\;\Varid{n}})$. A qual é possivél simplificar ainda mais assumindo $\ensuremath{\Varid{s}\;\Varid{n}} = (n + 2)(2n + 3)$ do qual se obtem que $\ensuremath{\Varid{s}\;\mathrm{0}} = 6$ e que $\ensuremath{\Varid{s}\;(\Varid{n}\mathbin{+}\mathrm{1})} = 4n + 9 + \ensuremath{\Varid{s}\;\Varid{n}}$, e , como as demais, é possivél simplificar ainda mais definindo $\ensuremath{\Varid{j}\;\Varid{n}} = 4n + 9$, que permite obter $\ensuremath{\Varid{j}\;\mathrm{0}} = 9$ e que $\ensuremath{\Varid{j}\;(\Varid{n}\mathbin{+}\mathrm{1})} = 4 + \ensuremath{\Varid{j}\;\Varid{n}}$, a qual é impossivél simplificar mais. Daí que se obtém a seguinte quatro funções mutuamente recursivas.
...
\\
\>[B]{}\Varid{c}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{k}\;\Varid{x}\;\Varid{n})\mathbin{+}(\Varid{c}\;\Varid{x}\;\Varid{n}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{k}\;\Varid{x}\;\mathrm{0}\mathrel{=}\mathbin{-}(\Varid{x}\mathbin{\uparrow}\mathrm{2})\mathbin{/}\mathrm{2}{}\<[E]%
\\
\>[B]{}\Varid{k}\;\Varid{x}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\mathbin{-}\Varid{x}\mathbin{\uparrow}\mathrm{2}\mathbin{/}(\mathrm{2}\mathbin{*}(\Varid{s}\;\Varid{n})))\mathbin{*}(\Varid{k}\;\Varid{x}\;\Varid{n}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{s}\;\mathrm{0}\mathrel{=}\mathrm{6}{}\<[E]%
\\
\>[B]{}\Varid{s}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{j}\;\Varid{n})\mathbin{+}(\Varid{s}\;\Varid{n}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{j}\;\mathrm{0}\mathrel{=}\mathrm{9}{}\<[E]%
\\
\>[B]{}\Varid{j}\;(\Varid{n}\mathbin{+}\mathrm{1})\mathrel{=}\mathrm{4}\mathbin{+}(\Varid{j}\;\Varid{n}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{loop}\;(\Varid{c},\Varid{k},\Varid{s},\Varid{j})\mathrel{=}(\Varid{k}\mathbin{+}\Varid{c},\mathbin{-}(\Varid{x}\mathbin{\uparrow}\mathrm{2})\mathbin{/}(\mathrm{2}\mathbin{*}\Varid{s})\mathbin{*}\Varid{k},\Varid{j}\mathbin{+}\Varid{s},\mathrm{4}\mathbin{+}\Varid{j}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{init}\mathrel{=}(\mathrm{1},\mathbin{-}(\Varid{x}\mathbin{\uparrow}\mathrm{2})\mathbin{/}\mathrm{2},\mathrm{6},\mathrm{9}){}\<[E]%
\\
\>[B]{}\hsindent{4}{}\<[4]%
\>[4]{}\Varid{prj}\;(\Varid{c},\Varid{k},\Varid{s},\Varid{j})\mathrel{=}\Varid{c}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Conid{B}\;(\Varid{a},\Varid{b},\Conid{FS}\;\Varid{a}\;\Varid{b})\mathrel{=}[\mskip1.5mu (\Varid{a},\Varid{b}+(\Conid{FS}\;\Varid{a}\;\Varid{b}))\mskip1.5mu]{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{25}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{outNode}\mathbin{::}\Conid{Node}\;\Varid{a}\;\Varid{b}\to {}\<[25]%
\>[25]{}\Varid{b}+(\Conid{FS}\;\Varid{a}\;\Varid{b}){}\<[E]%
\\
\>[B]{}\Varid{outNode}\;(\Conid{File}\;\Varid{b})\mathrel{=}i_1\;\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{outNode}\;(\Conid{Dir}\;\Varid{fs})\mathrel{=}i_2\;\Varid{fs}{}\<[E]%
\\[\blanklineskip]%
...
&
    \ensuremath{[\mskip1.5mu \Varid{a}\times(\Varid{b}\mathbin{+}(\Conid{FS}\;\Varid{a}\;\Varid{b}))\mskip1.5mu]}
           \ar[d]^{\ensuremath{\map \;(\Varid{id}\times(\Varid{id}\mathbin{+}(\Varid{cataFS}\;\Varid{g})))}}
\\
     \ensuremath{\Conid{C}}
&
     \ensuremath{[\mskip1.5mu \Varid{a}\times(\Varid{b}\mathbin{+}\Conid{C})\mskip1.5mu]}
           \ar[l]^-{\ensuremath{\Varid{g}}}
}
\end{eqnarray*}
...
\\
     \ensuremath{\Conid{C}}
           \ar[u]^-{\ensuremath{\Varid{anaFS}\;\Varid{g}}}
           \ar[r]_-{\ensuremath{\Varid{g}}}
&
     \ensuremath{[\mskip1.5mu \Varid{a}\times(\Varid{b}\mathbin{+}\Conid{C})\mskip1.5mu]}
           \ar[u]_{\ensuremath{\map \;(\Varid{id}\times(\Varid{id}\mathbin{+}(\Varid{anaFS}\;\Varid{g})))}}         
}
\end{eqnarray*}
...
\\
\>[B]{}\Varid{check}\mathrel{=}\Varid{cataFS}\;(\Varid{checkAll}\comp \Varid{checkSub}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{checkSub}\mathrel{=}\map \;(\Varid{id}\times\alt{\underline{\Conid{True}}}{\Varid{id}}){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{checkCur}\mathrel{=}\uncurry{(\equiv )}\comp \conj{\Varid{nub}}{\Varid{id}}\comp \map \;\p1{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{getMin}\mathrel{=}\Varid{cond}\;(\equiv [\mskip1.5mu \mskip1.5mu])\;\underline{\Conid{True}}\;(\Varid{minimum}\comp \map \;\p2){}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{checkAll}\mathrel{=}\uncurry{(\mathrel{\wedge})}\comp \conj{\Varid{checkCur}}{\Varid{getMin}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{tar}\mathrel{=}\Varid{cataFS}\;(\Varid{concat}\comp \map \;(\Varid{mapPath}\comp (\Varid{id}\times\alt{\Varid{filePath}}{{}\<[64]%
\>[64]{}\Varid{id}}))){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{filePath}\mathrel{=}\Varid{singl}\comp \conj{\underline{[\mskip1.5mu \mskip1.5mu]}}{\Varid{id}}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{mapPath}\;(\Varid{a},\Varid{b})\mathrel{=}\map \;((\mathbin{:})\;\Varid{a}\times\Varid{id})\;\Varid{b}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{untar}\mathrel{=}\Varid{joinDupDirs}\comp \Varid{anaFS}\;(\map \;(\Varid{cond}\;((\equiv \mathrm{1})\comp \length \comp \p1)\;(\Varid{head}\timesi_1)\;\Varid{untarPath})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{untarPath}\mathrel{=}\conj{\Varid{head}\comp \p1}{i_2\comp \Varid{singl}\comp \conj{\Varid{tail}\comp \p1}{\p2}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{find}\;\Varid{a}\mathrel{=}\Varid{cataList}\;\alt{\underline{[\mskip1.5mu \mskip1.5mu]}}{{}\<[39]%
\>[39]{}\Varid{keepCond}\;\Varid{a}}\comp \Varid{tar}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{keepCond}\;\Varid{a}\mathrel{=}\Varid{cond}\;((\equiv \Varid{a})\comp \Varid{last}\comp \p1\comp \p1)\;(\uncurry{(\mathbin{:})}\comp (\p1\times\Varid{id}))\;\p2{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{new}\;\Varid{p}\;\Varid{b}\mathrel{=}\Varid{untar}\comp ((\Varid{p},\Varid{b})\mathbin{:})\comp \Varid{tar}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{cp}\;\Varid{orig}\;\Varid{dest}\mathrel{=}\Varid{cond}\;(\Varid{isJust}\comp \p1)\;(\uncurry{(\Varid{new}\;\Varid{dest})}\comp (\Varid{fromJust}\times\Varid{id}))\;\p2\comp \conj{\Varid{lookup}\;\Varid{orig}\comp \Varid{tar}}{\Varid{id}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\\
\>[B]{}\Varid{rm}\;\Varid{p}\mathrel{=}\Varid{untar}\comp \Varid{filter}\;((\not\equiv \Varid{p})\comp \p1)\comp \Varid{tar}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
